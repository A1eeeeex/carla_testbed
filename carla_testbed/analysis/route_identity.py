...
def analyze_route_identity_from_route_contract(route_contract: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "length_expected_source": route_contract.get("scenario_route_length_source"),
        "length_expected_declared_m": route_contract.get("scenario_route_declared_length_m"),
        "length_expected_claim_m": route_contract.get("scenario_route_claim_length_m"),
        "length_expected_claim_source": route_contract.get("scenario_route_claim_length_source"),
        "length_expected_legacy_m": route_contract.get("scenario_route_legacy_length_m"),
        "length_expected_legacy_role": route_contract.get("scenario_route_legacy_length_role"),
        "length_expected_trace_m": route_contract.get("scenario_route_trace_length_m"),
        "length_expected_trace_source": route_contract.get("scenario_route_trace_length_source"),
        "length_expected_consistency_status": route_contract.get("scenario_route_length_consistency_status"),
        "length_expected_consistency_reason": route_contract.get("scenario_route_length_consistency_reason"),
...
def route_identity_summary_md(report: Mapping[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"- Expected length source: `{report.get('length_expected_source')}`",
            f"- Expected claim length m: `{report.get('length_expected_claim_m')}`",
            f"- Expected legacy length m: `{report.get('length_expected_legacy_m')}`",
            f"- Expected legacy length role: `{report.get('length_expected_legacy_role')}`",
            f"- Expected trace length m: `{report.get('length_expected_trace_m')}`",
            f"- Expected length consistency: `{report.get('length_expected_consistency_status')}`",
