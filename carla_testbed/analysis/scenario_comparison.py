...
def _run_entry(run_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "primary_behavior_blocker": phase1_status.get("primary_behavior_blocker"),
        "behavior_blocker_layer": phase1_status.get("behavior_blocker_layer"),
        "behavior_next_action": phase1_status.get("behavior_next_action"),
        "behavior_blocker_evidence": dict(phase1_status.get("behavior_blocker_evidence") or {}),
        "primary_setup_blocker": phase1_status.get("primary_setup_blocker"),
        "setup_blocker_layer": phase1_status.get("setup_blocker_layer"),
        "setup_next_action": phase1_status.get("setup_next_action"),
        "setup_blocker_evidence": dict(phase1_status.get("setup_blocker_evidence") or {}),
        ...
        results.append(
            {
                ...
                "behavior_blocker_layer": run.get("behavior_blocker_layer"),
                "behavior_next_action": run.get("behavior_next_action"),
                "behavior_blocker_evidence": dict(run.get("behavior_blocker_evidence") or {}),
