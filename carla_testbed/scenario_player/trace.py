...
def build_actor_trace_row(
    *,
    ...
    return {
        ...
        "trajectory_progress_m": actor.trajectory_progress_m,
        "route_progress_gap_m": actor.route_progress_gap_m,
        "route_progress_gap_source": actor.route_progress_gap_source,
        "target_lane_id": _target_lane_id(action),
        "lane_change_progress": lane_change_progress,
        "lane_change_runtime_mode": action.get("lane_change_runtime_mode") if action else None,
        "physics_controlled_lane_change": action.get("physics_controlled_lane_change") if action else None,
        "claim_grade_lane_change": action.get("claim_grade_lane_change") if action else None,
        "velocity_source": action.get("velocity_source") if action else None,
        "trigger_frame": action.get("trigger_frame") if action else None,
        "x": actor.x,
        "y": actor.y,
        "z": actor.z,
        "yaw": actor.yaw_rad,
        ...
        "height_m": actor.height_m,
        "bbox_extent_x_m": actor.bbox_extent_x_m,
        "bbox_extent_y_m": actor.bbox_extent_y_m,
        "bbox_extent_z_m": actor.bbox_extent_z_m,
