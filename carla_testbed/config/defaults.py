...
class HarnessConfig:
    ...
    ego_id: str = "hero"
    ros2_namespace: str = "/carla"
    enable_ros2_native: bool = False
    ros_invert_tf: bool = True
    enable_ros2_gt: bool = False
    ros2_gt_publish_tf: bool = True
    ros2_gt_publish_odom: bool = True
    ros2_gt_publish_objects3d: bool = True
    ros2_gt_publish_markers: bool = True
    ros2_gt_objects_radius_m: float = 120.0
    ros2_gt_max_objects: int = 64
    ros2_gt_odom_hz: float = 20.0
    ros2_gt_tf_hz: float = 20.0
    ros2_gt_objects_hz: float = 10.0
    ros2_gt_markers_hz: float = 10.0
    ros2_gt_qos_reliability: str = "best_effort"
    ros2_gt_qos_depth: int = 10
