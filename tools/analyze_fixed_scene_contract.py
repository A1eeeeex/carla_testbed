...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze fixed-scene storyboard/trace contract")
    ...
    if args.run_dir:
        report = analyze_fixed_scene_contract_run_dir(args.run_dir)
    else:
    ...
    write_fixed_scene_contract_report(report, args.out)
