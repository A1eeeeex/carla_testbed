#!/usr/bin/env python3
# LEGACY / OPERATIONAL HELPER: retained for historical unified calibration orchestration.
# Do not add new platform logic here; move reusable code into carla_testbed.calibration.
# Migration target: carla_testbed.calibration profile and report pipeline.
