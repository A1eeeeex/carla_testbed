...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LOCALIZATIONSTATUS'].fields_by_name['gnss_status']._loaded_options = None
  _globals['_LOCALIZATIONSTATUS'].fields_by_name['gnss_status']._serialized_options = b'\030\001'
  _globals['_LOCALIZATIONSTATUS'].fields_by_name['lidar_status']._loaded_options = None
  _globals['_LOCALIZATIONSTATUS'].fields_by_name['lidar_status']._serialized_options = b'\030\001'
