...
def _calibration_probe_extra_args(detail: str) -> List[str]:
    ...
    return [
        ...
        "2.0",
        "--throttle-commands",
        "0.0,0.1,0.15,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.7,0.8,0.9,1.0",
        "--throttle-sample-sec",
        "3.2",
        ...
        "0.0,0.03,0.05,0.08,0.1,0.12,0.15,0.18,0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.6,0.7,0.8,0.9,1.0",
