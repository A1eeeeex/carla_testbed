...
def _phase1_fixed_scene_runtime_settings(effective_cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "post_reset_ego_speed_ready_mps": float(
            runtime_cfg.get("post_reset_ego_speed_ready_mps") or 0.0
        ),
        "post_reset_ego_speed_ready_hold_ticks": int(
            runtime_cfg.get("post_reset_ego_speed_ready_hold_ticks") or 1
        ),
    ...
    try:
        ...
        if fixed_scene_runtime_settings["enabled"]:
            ...
            fixed_scene_runtime_hook = setup_fixed_scene_runtime_hook(
                ...
                post_reset_ego_speed_ready_hold_ticks=int(
                    fixed_scene_runtime_settings["post_reset_ego_speed_ready_hold_ticks"]
                ),
