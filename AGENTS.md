...
- `reference_pack_carla_ros2_apollo/reference/`
...
1. `README.md`
2. `docs/README.md`
3. `reference_pack_carla_ros2_apollo/reference/00_index.md`
4. `reference_pack_carla_ros2_apollo/reference/01_system_overview/project_map.md`
5. `reference_pack_carla_ros2_apollo/reference/01_system_overview/runtime_flow.md`
6. `reference_pack_carla_ros2_apollo/reference/03_interface_contracts/topic_contracts.md`
7. `reference_pack_carla_ros2_apollo/reference/03_interface_contracts/control_semantics.md`
8. `reference_pack_carla_ros2_apollo/reference/04_runtime_and_debug/debug_playbook.md`
9. `reference_pack_carla_ros2_apollo/reference/05_verified_findings/current_truths.md`
10. `reference_pack_carla_ros2_apollo/reference/05_verified_findings/to_verify_items.md`
11. `reference_pack_carla_ros2_apollo/reference/07_experiments_and_acceptance/acceptance_criteria.md`
...
1. Inspect the relevant `reference_pack_carla_ros2_apollo/reference/` pages first.
...
- Stable truth / interface contract / durable decision:
  - update `reference_pack_carla_ros2_apollo/reference/`
...
- If a result is still uncertain or conflicts with other evidence, put it in `reference_pack_carla_ros2_apollo/reference/05_verified_findings/to_verify_items.md`.
